    ...
    render() {
        return (
            <div className={'code megatron'} onClick={this.handleMouseDown}>
                <Typist avgTypingDelay={this.state.typeSpeed} stdTypingDelay={this.state.stdTypeDelay}
                        delayGenerator={this.changeGenerator} onClick={this.handleMouseDown} className={'typist'}>
                    <div className={'scope0 invisible'} onClick={this.handleMouseDown}>{String.fromCharCode(2000)}</div>
                    <div className={'scope0'} onClick={this.handleMouseDown}><p>{'public class MinhVuNguyen { '}</p>
                    </div>
                    <div className={'scope1'} onClick={this.handleMouseDown}>{'boolean loop=true;'}</div>
                    <div className={'scope0 invisible'} onClick={this.handleMouseDown}>{String.fromCharCode(2000)}</div>
                    <div className={'scope1'}
                         onClick={this.handleMouseDown}>{'public static void main (String []args) {'}</div>
                    ...
                    <div className={'scope3'} onClick={this.handleMouseDown}>{['if (answer==\'',
                        <a  href={'about'}><span onMouseEnter={this.handleMouseEnter}
                                                onMouseLeave={this.handleMouseLeave}
                                                className="bold">About Me</span>
                        </a>, '\'){']}</div>
